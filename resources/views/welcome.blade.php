    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <a href="/sesion" class="btn btn-danger d-flex align-items-center justify-content-center mb-3 font-weight-bold font-size: 18px;">
                            <img src="img/icons/familyuser.png" class="rounded" id="logo" alt="" style="width: 40%; height: 70%;">
                            PADRES DE FAMILIA
                        </a>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <a href="/sesionadmin" class="btn btn-dark d-flex align-items-center justify-content-center mb-3 font-weight-bold font-size: 18px;">
                            <img src="img/icons/administrator.png" class="rounded" id="logo" alt="" style="width: 40%; height: 70%;">
                            ADMINISTRADOR
                        </a>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <a href="#" class="btn btn-success btn-lg d-flex align-items-center justify-content-center mb-3 font-weight-bold font-size: 18px;">
                            <img src="img/icons/mu.png" class="rounded" id="logo" alt="" style="width: 40%; height: 70%;">
