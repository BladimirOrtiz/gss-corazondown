    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <a href="/clarificationfamily" class="btn btn-primary d-flex align-items-center justify-content-center mb-3 font-weight-bold font-size: 18px;">
                            <img src="img/icons/du.png" class="rounded" id="logo" alt="" style="width: 40%; height: 70%;">
            ...
            <div class="col-md-6">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <a href="#" class="btn btn-danger d-flex align-items-center justify-content-center mb-3 font-weight-bold font-size: 18px;">
                            <img src="img/icons/ru.png" class="rounded" id="logo" alt="" style="width: 40%; height: 30%;">
