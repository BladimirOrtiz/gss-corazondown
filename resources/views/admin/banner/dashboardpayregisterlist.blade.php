        ...
        <div class="container">
            ...
            <table class="styled-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $register->pay_type }}</td>
                        <td>{{ $register->school_cycle }}</td>
                        <td>{{ $register->pay_month }}</td>
                        <td>{{ $register->pay_date }}</td>
                        <td>{{ $register->pay_import }}</td>
                        <td>{{ $register->discount_rate }}</td>
                        <td>{{ $register->qr_code }}</td>
                        <td>{{ $register->pay_concept }}</td>
                        <td>{{ $register->pay_observation }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
