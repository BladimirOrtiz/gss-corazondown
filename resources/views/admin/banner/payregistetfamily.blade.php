...
<body>
        ...
        <form action="{{ route('payregister.create', $user->id_user) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="school_cycle" name="school_cycle" required>
                    ...
                    @endphp
                    @for ($year = $startYear; $year <= $endYear; $year++) <option value="{{ $year }}-{{ $year + 1 }}">{{ $year }}-{{ $year + 1 }}</option>
                        @endfor
                </select>
            </div>
            ...
            <div class="mb-3 form-check form-switch">
                <input class="form-check-input" type="checkbox" id="payment_confirm" name="payment_confirm">
            ...
            <div class="mb-3" id="payment-section" style="display: none;">
                ...
                <input type="number" step="0.01" class="form-control" id="payment" name="payment" min="0" disabled>
            </div>

            <div class="mb-3" id="remain-pay-section" style="display: none;">
                <label for="remain_pay" class="form-label">Cantidad Restante</label>
                <input type="number" step="0.01" class="form-control" id="remain_pay" name="remain_pay" min="0" disabled>
            </div>
            <div class="mb-3 form-check form-switch">
    ...
    // Mostrar/ocultar secciones basadas en el estado del checkbox
    ...
    // Calcular la cantidad restante cuando se ingresa un abono
    ...
    // También recalcular cuando se cambia el importe de pago
