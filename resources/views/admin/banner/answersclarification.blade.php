...
<head>
    ...
    <title>LISTADO DE ACLARACIONES O QUEEJAS</title>
</head>
                ...
                <table class="styled-table">
                    <thead>
                        <tr>
                            ...
                            <th>CATEGORIA DEL PROCESO</th>
                            <th>DESCRIPCIÓN DEL PROCESO</th>
                            <th>FECHA DE CREACIÓN DEL PROCESO</th>
                            <th>ESTADO DEL PROCESO</th>
                            <th>CREAR RESPUESTA</th>

                        </tr>
                    </thead>
                    <tbody id="pay_register_table_body">
                        @foreach($Dataclarification as $clarification)
                        <tr>
                            <td>{{ $clarification->user->username }}</td>
                            ...
                            <td> <a href="{{ route('answers_clarifications.show', ['id_user' => $clarification->user->id_user]) }}" class="btn btn-light" title="Ver Respuestas">
                                {{ $clarification->clarification_state }}</a></td>
                            <td>
                                <a href="{{ route('answers.create', ['id_user' => $clarification->user->id_user, 'id_clarification' => $clarification->id_clarification ]) }}" class="btn btn-light" title="Responder Proceso">
                                    <img src="img/icons/aws.png" alt="Imagen" width="50" height="50">
                                </a>
                            </td>
